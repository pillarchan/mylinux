...
class bt_api:
    ...
    def close_to_https_multiple(self,sitelist):
        """sitelist is a dict {site: siteId}"""
...
if __name__ == '__main__':
    ...
    file = c_file()
    sitelist = file.read_xlsx(filename)
    # print(action)
    ...
    elif  str_action == 'close_to_https':
        bt_tz.close_to_https_multiple(sitelist)
    else:
        print('操作不存在')
