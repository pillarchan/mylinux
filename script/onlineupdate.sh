...
case $1 in
    app)
        PRODUCTION_DIR="$SITE_BASE_DIR/chatApi/"
        RUNTIME_DIR="runtime"
        ARCHIVE_BASE_DIR=/opt/app_dep
        ;;
    admin)
        PRODUCTION_DIR="$SITE_BASE_DIR/chatAdmin/"
        RUNTIME_DIR="runtime"
       ARCHIVE_BASE_DIR=/opt/admin_dep
        ;;
    serv)
        PRODUCTION_DIR="$SITE_BASE_DIR/chatservice/"
        RUNTIME_DIR="runtime"
       ARCHIVE_BASE_DIR=/opt/service_dep
        ;;	
   websock)
        PRODUCTION_DIR="$SITE_BASE_DIR/chatwebsocket/"
        RUNTIME_DIR="runtime"
       ARCHIVE_BASE_DIR=/opt/websocket_dep
        ;;  
...
chown -R root.root  /home/wwwroot/chatApi/
chown -R www.www /home/wwwroot/chatApi/runtime
chown -R www.www /home/wwwroot/chatApi/public/uploads

chown -R root.root  /home/wwwroot/chatAdmin
chown -R www.www /home/wwwroot/chatAdmin/runtime 
chown -R www.www /home/wwwroot/chatAdmin/data/upload
